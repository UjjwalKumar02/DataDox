...
# Curated list of common technical skills & aliases
SKILL_ALIASES = {
...
# Flatten alias map with reverse mapping to canonical skill
ALIAS_MAP = {}
...
def extract_skills(text: str):
    ...
    Returns a dict with canonical skill as key and matched alias as value.
    """
    text = text.lower()
    found_skills = {}
    ...
    for alias, skill in ALIAS_MAP.items():
        ...
        if re.search(pattern, text):
            found_skills[skill] = alias  # store the alias that matched
